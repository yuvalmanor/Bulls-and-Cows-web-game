...
/*Description: This function does all of the WinSock logistics and calls playGame function
* Arguments:
* 1. char* ip - The server's IP address 
* 2. int portNumber - The server's port number
* 3. char* username - The username the player chose
